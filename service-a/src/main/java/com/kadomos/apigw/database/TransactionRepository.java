...
public interface TransactionRepository extends JpaRepository<Transaction, Integer> {
     ...
     * @return
     */
    @Query(nativeQuery = true, value="SELECT * FROM transaction_a tr ORDER BY tr.created_date DESC LIMIT 1")
     ...
     */
    @Modifying
    @Query(nativeQuery = true, value = "INSERT INTO transaction_a (description,value,balance,modified_date,created_date, type) VALUES (:description,:value,:balance,:modified_date,:created_date, :type)")
    @Transactional
